        ...
        <article className={styles.homepage}>
          ...
          <section className='category'>
            ...
            <ul className='sectionList'>
              <ListItem
                entry={DataLoader.all["Centhrian-Pantheon"]}
                imgStyle='landscape'
              />
              <ListItem
                entry={DataLoader.all["The-Vesdarian-Calendar"]}
                imgStyle='landscape'
              />
              <ListItem
                entry={DataLoader.all["The-Second-Convergence"]}
                imgStyle='landscape'
              />
              <ListItem
                entry={DataLoader.all["Lords-of-the-Fell"]}
                imgStyle='landscape'
              />
              <ListItem
                entry={DataLoader.all["Courts-of-the-Feywild"]}
                imgStyle='landscape'
              />
              <ListItem
                entry={DataLoader.all["Khün-Mönnas"]}
                imgStyle='landscape'
              />

              <ListItem
                entry={DataLoader.all["The-Three-Moons-of-Centhris"]}
                imgStyle='landscape'
              />
              <ListItem
                entry={DataLoader.all["Navolin"]}
                imgStyle='landscape'
              />
              <ListItem
                entry={DataLoader.all["Lemuria"]}
                imgStyle='landscape'
              />
              <ListItem
                entry={DataLoader.all["Rakenburg"]}
                imgStyle='landscape'
              />
              <ListItem
                entry={DataLoader.all["Kilurus"]}
                imgStyle='landscape'
              />
