...
import banner from "img/lore/banners/runesmithing-banner.jpg";
                ...
                return (
                  <li className="rune" key={key}>
                    ...
                    <div className="runeCost">
                      <span className="num">{this.state.activeRuneList[key].baseCost}</span>gp
                    </div>
                  </li>
                );
              }
        ...
        <article className="dwarfRunes article">
          ...
          <div className="mainContent">
            {WikiUtils.linkContent(
              runesArticle.entry,
              WikiUtils.textFormatting(runesArticle.entry.description),
                  ...
                  return (
                    <li className="rule" key={rule}>
                      ...
                      {rule.description.map((str) => {
                        return <p>{WikiUtils.textFormatting(str)}</p>;
                      })}
                    </li>
                  );
                })}
