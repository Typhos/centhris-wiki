...
export default class LocationCard extends Component {
  arrayToLi = function (value) {
    return value.map((val) => (
      <li className="infoCard__listItem" key={val}>
        {val}
      </li>
    ));
  };
      ...
      <React.Fragment>
        ...
        {entry.capital && (
          <div className="infoCard__row">
            ...
            <div className="infoCard__values">
              {WikiUtils.linkContent(entry, entry.capital, {
                paragraphName: "infoCard__entry",
                linkName: "infoCard__link",
              })}
            </div>
          </div>
        )}
        ...
        {entry.location && (
          <div className="infoCard__row">
            ...
            <div className="infoCard__values">
              {WikiUtils.linkContent(entry, entry.location, {
                paragraphName: "infoCard__entry",
                linkName: "infoCard__link",
              })}
            </div>
        ...
        {entry.guards && (
          <div className="infoCard__row">
            <p className="infoCard__key">Professional Guards</p>
            <p className="infoCard__values">{entry.guards}</p>
          </div>
        )}

        {entry.levy && (
          <div className="infoCard__row">
            <p className="infoCard__key">Militia Levy</p>
            <p className="infoCard__values">{entry.levy}</p>
          </div>
        )}

        {entry.garrison && (
          <div className="infoCard__row">
            <p className="infoCard__key">Garrison</p>
            <p className="infoCard__values">{entry.garrison}</p>
          </div>
        )}
        ...
        {entry.leaders && (
          <div className="infoCard__row">
            ...
            <div className="infoCard__values">
              {WikiUtils.linkContent(entry, entry.leaders, {
                paragraphName: "infoCard__entry",
                linkName: "infoCard__link",
              })}
            </div>
        ...
        {entry.river && (
          <div className="infoCard__row">
            <p className="infoCard__key">Water Source(s)</p>
            <div className="infoCard__values">
              {WikiUtils.linkContent(entry, entry.river, {
                paragraphName: "infoCard__entry",
                linkName: "infoCard__link",
              })}
            </div>
        ...
        {entry.lake && (
          <div className="infoCard__row">
            <p className="infoCard__key">Water Source(s)</p>
            <div className="infoCard__values">{WikiUtils.linkContent(entry, entry.lake)}</div>
          </div>
        )}
        ...
        {entry.districts && (
          <div className="infoCard__row">
            ...
            <div className="infoCard__values">
              {WikiUtils.linkContent(entry, entry.districts, {
                paragraphName: "infoCard__entry",
                linkName: "infoCard__link",
              })}
            </div>
        ...
        {entry.cities && (
          <div className="infoCard__row">
            ...
            <div className="infoCard__values">
              {WikiUtils.linkContent(entry, entry.cities, {
                paragraphName: "infoCard__entry",
                linkName: "infoCard__link",
              })}
            </div>
        ...
        {entry.races && (
          <div className="infoCard__row">
            ...
            <div className="infoCard__values">
              {WikiUtils.linkContent(entry, entry.races, {
                paragraphName: "infoCard__entry",
                linkName: "infoCard__link",
              })}
            </div>
        ...
        {entry.nation && (
          <div className="infoCard__row">
            ...
            <div className="infoCard__values">
              {WikiUtils.linkContent(entry, entry.nation, {
                paragraphName: "infoCard__entry",
                linkName: "infoCard__link",
              })}
            </div>
        ...
        {entry.regions && (
          <div className="infoCard__row">
            ...
            <div className="infoCard__values">
              {WikiUtils.linkContent(entry, entry.regions, {
                paragraphName: "infoCard__entry",
                linkName: "infoCard__link",
              })}
            </div>
        ...
        {entry.map && (
          <div className="infoCard__altImg">
            ...
            <a href={getImgPath(entry.map.replace(/\s/g, "-"))}>
              <img
                alt="map"
                className="infoCard__bonusImg"
                src={getImgPath(entry.map.replace(/\s/g, "-"))}
              />
            </a>
          </div>
        )}
